...
from dragonfly import Rule, Grammar, get_engine
...
class RemoteRule(Rule):
    ...
    def process_recognition(self, node):
        from dragonfly.engines.backend_remote.server import ServerEngine
        from dragonfly.engines.backend_remote.server import Action
