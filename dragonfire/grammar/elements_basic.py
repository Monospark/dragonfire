...
classes:
 ...
 - :class:`RuleRef` --
   reference to a :class:`dragonfire.grammar.rule_base.Rule` object;
   this element allows a rule to include (i.e. reference) another rule
 - :class:`ListRef` --
   reference to a :class:`dragonfire.grammar.list.List` object
...
classes listed above:
 ...
 - :class:`DictListRef` --
   reference to a :class:`dragonfire.all.DictList` object; this element is 
   similar to the :class:`dragonfire.all.ListRef` element, except that it 
...
class ElementBase(object):
    ...
    def value(self, node):
        """
            ...
            Argument:
             - *node* --
               a :class:`dragonfire.grammar.state.Node` instance
...
class Sequence(ElementBase):
    """
        ...
        *children* constructor argument.
        ...
        Example usage:
        >>> from dragonfire.test import ElementTester
