...
from dragonfire.engines.backend_natlink.dictation import NatlinkDictationContainer
from dragonfire.engines.backend_sapi5.dictation import Sapi5DictationContainer
from dragonfire.grammar.grammar_base import Grammar
from dragonfire.engines.backend_remote import remote
from dragonfire.engines.base import EngineBase
...
class ServerEngine(EngineBase):
    ...
    def __init__(self, type):
        ...
        self.__type = type
        if type == ServerEngineType.NATLINK:
            ServerEngine.DictationContainer = NatlinkDictationContainer
        else:
            ServerEngine.DictationContainer = Sapi5DictationContainer
